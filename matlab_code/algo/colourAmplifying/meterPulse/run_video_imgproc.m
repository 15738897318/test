...
% alpha = 150; 50 : 30 : 80; %Eulerian magnifier %Standard: < 50
% pyr_level = 6; 4 : 2 : 6; %Standard: 4, but updated by the real frame size
% min_hr = 140; 30 : 10 : 50; %BPM %Standard: 30
% max_hr = 160; 60 : 30 : 210; %BPM %Standard: > 150
% frame_rate = 30; %Standard: 30, but updated by the real frame-rate
% chroma_magnifier = 1; 1 : 2; %Standard: 1

resultsDir = 'Results';
src_folder = '/Users/misfit/Desktop/Codes - Local/Active/bioSignal/Codes/main/matl/';
