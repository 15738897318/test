...
min_hr = 3; 30; %BPM %Standard: 30
max_hr = 30; 240; %BPM %Standard: > 150
frame_rate = 30; %Standard: 30, but updated by the real frame-rate
chroma_magnifier = 0; %Standard: 1

alphas = 150; [-101 : 20 : 101]; %Eulerian magnifier %Standard: < 50
pyr_levels = 6; [2 : 2 : 6]; %Standard: 6, but updated by the real frame size
if length(alphas) == 1
	alpha = alphas(1);
